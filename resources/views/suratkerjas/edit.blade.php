...
<div class="card card-primary">
    ...
    <form method="POST" action="{{route('suratkerjas.update', $suratkerja->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="worker_id" style="width: 100%;">
                            ...
                            @foreach ($worker as $p)
                                <option value="{{ $p->id }}" {{ $suratkerja->worker_id  == $p->id ? 'selected' : '' }}>{{ $p->user->name }}</option>
                            @endforeach
                        </select>
                        @error('worker_id')
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" name="surat_kerja_file" class="custom-file-input">
