...
<div class="card card-primary">
    ...
    <form method="POST" action="{{route('surataktifs.store')}}" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <label >Tanggal Surat Aktif</label>
                        <input type="date" name="tgl_surat_aktif" class="form-control" value="{{ old('tgl_surat_aktif') }}">
